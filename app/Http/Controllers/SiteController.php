...
class SiteController extends Controller
{
    ...
    public function blogDetails($slug)
    {
        ...
        $latestBlogs = Frontend::where('id', '!=', $blog->id)->where('data_keys', 'blog.element')->latest()->limit(8)->get();
        $pageTitle   = @$blog->data_values->title;
        $seoContents = $blog->seo_content;
        $seoImage    = @$seoContents->image ? frontendImage('blog', $seoContents->image, getFileSize('seo'), true) : null;
        return view('Template::blog_details', compact('pageTitle', 'blog', 'latestBlogs', 'seoContents', 'seoImage'));
    }
    ...
    public function loans()
    {
        ...
        return view('Template::loan', compact('pageTitle', 'categories'));
    }
