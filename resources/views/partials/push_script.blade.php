    ...
    function pushNotifyAction(){
        ...
        if(!('Notification' in window)){
            ...
            <div class="alert border border--primary" role="alert">
                <div class="alert__icon d-flex align-items-center text--primary"><i class="fas fa-bell"></i></div>
                <p class="alert__message">
                    <span class="fw-bold">@lang('Please Allow / Reset Browser Notification') <i class='las la-bell text--danger'></i></span><br>
