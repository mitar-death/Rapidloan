    ...
    public function run()
    {
        ...
        $blogs = [
            [
                ...
                'description' => "
                    <p>Sarah Jenkins started 'The Flourish Kitchen' in her modest home oven with a single goal: to share her grandmother's sourdough recipe with her neighborhood. Within months, her weekly subscription list grew from five neighbors to over fifty, and her kitchen was overflowing with flour sacks and proofing baskets. Sarah knew she had reached a crossroads—scale up or stop growing.</p>
                    <p>Scaling meant more than just a larger oven; it meant a professional-grade storefront, three industrial mixers, and hiring her first staff member. Traditional lenders were hesitant to support a home-based business with less than a year of commercial history. That's where our SME Growth Accelerator loan came in. With a $15,000 injection, Sarah secured a lease in Canary Wharf, fitted out her boutique shop, and purchased high-capacity equipment.</p>
                    <p>Today, 'The Flourish Kitchen' is a staple of North Street. Sarah has tripled her daily production, employs three local residents, and is already planning her second location. 'The loan wasn't just capital,' Sarah says, 'it was the bridge between a hobby and a legacy.'</p>
                ",
            ...
            [
                ...
                'description' => "
                    <p>At 28, John Clarkson, a junior analyst in London, had a clear vision: owning his first apartment. However, years of small credit card debts and a lack of financial planning had left him with a credit score that made mortgage brokers look the other way. John felt trapped in a cycle of high-interest short-term loans that barely covered his expenses.</p>
                    <p>His journey to financial health began with our Debt Consolidation Relief plan. By combining his high-interest debts into one manageable monthly payment with a lower interest rate, John was able to breathe. We provided him with a structured 18-month roadmap, focusing on consistent repayment and strategic credit utilization. This wasn't just about paying off debt; it was about rebuilding his financial identity.</p>
                    <p>Fast forward to today: John's credit score has increased by 165 points. He recently secured a Premier Home Upgrade loan at a competitive rate, transforming his new flat into a modern living space. John's story proves that with the right tools and a solid plan, the 'credit maze' can be successfully navigated by anyone.</p>
                ",
            ...
            [
                ...
                'description' => "
                    <p>For Michael Chen, CEO of 'Vortex Stream', Tuesday morning started with a nightmare. Just three days before their biggest product launch of the year, a catastrophic power surge at their primary data center fried their core server array. Without immediate replacement, the launch—representing six months of development and 40% of their annual revenue—would fail.</p>
                    <p>Michael contacted his primary bank immediately, only to be told the approval process for an emergency equipment loan would take 7 to 10 business days. He couldn't wait 10 hours, let alone 10 days. Seeking a faster solution, he applied for our Emergency Financing. Because our platform is built for speed, we were able to verify his business standing and revenue metrics within hours.</p>
                    <p>By Wednesday morning, $7,500 was in Michael's account. By Wednesday afternoon, the new server array was installed and being configured. The launch went off without a hitch on Friday, breaking all previous sales records. 'Your Net Investment didn't just give us a loan,' Michael explains, 'they saved our company's future.'</p>
                ",
        ...
        Frontend::updateOrCreate(['data_keys' => 'plan.content', 'tempname' => 'basic'], ['data_values' => ['subheading' => 'Featured Plans', 'heading' => 'Flexible Loan Solutions Tailored for Your Success']]);

        // // 11. Realistic Client Logos
